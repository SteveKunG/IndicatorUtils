    ...
    public static void runGlowingEntityDetector()
    {
        ...
        if (mc.theWorld != null)
        {
            for (Entity list : mc.theWorld.loadedEntityList)
            {
                ...
                {
                    if (list instanceof EntityZombie && ((EntityZombie)list).getZombieType() == ZombieType.HUSK)
                    {
                        list.setGlowing(true);
                    }
                    else
                ...
                {
                    if (list instanceof EntitySkeleton && ((EntitySkeleton)list).getSkeletonType() == SkeletonType.WITHER)
                    {
                        list.setGlowing(true);
                    }
                    else
                ...
                {
                    if (list instanceof EntitySkeleton && ((EntitySkeleton)list).getSkeletonType() == SkeletonType.STRAY)
                    {
                        list.setGlowing(true);
                    }
                    else

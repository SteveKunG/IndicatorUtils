...
@Mod(modid = IndicatorUtils.MOD_ID, name = IndicatorUtils.NAME, version = IndicatorUtils.VERSION, dependencies = "after:Forge@[13.19.1.2188,);", clientSideOnly = true, guiFactory = IndicatorUtils.GUI_FACTORY)

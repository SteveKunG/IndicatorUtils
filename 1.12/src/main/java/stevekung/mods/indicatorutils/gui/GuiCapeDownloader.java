...
public class GuiCapeDownloader extends GuiScreen
{
    ...
    private void renderPlayer()
    {
        ...
        float f5 = this.mc.player.rotationYawHead;
        ...
        this.mc.player.renderYawOffset = 0.0F;
        this.mc.player.rotationYaw = (float) Math.atan(19 / 40.0F) * 40.0F;
        this.mc.player.rotationYaw = 0.0F;
        this.mc.player.rotationYawHead = this.mc.player.rotationYaw;
        GlStateManager.translate(0.0F, (float) this.mc.player.getYOffset(), 0.0F);
        RenderManager rendermanager = Minecraft.getMinecraft().getRenderManager();
        rendermanager.setPlayerViewY(180.0F);
        rendermanager.setRenderShadow(false);
        rendermanager.doRenderEntity(this.mc.player, 0.0D, 0.0D, 0.0D, 0.0F, 1.0F, false);
        rendermanager.setRenderShadow(true);
        this.mc.player.renderYawOffset = f2;
        this.mc.player.rotationYaw = f3;
        this.mc.player.rotationPitch = f4;
        this.mc.player.rotationYawHead = f5;

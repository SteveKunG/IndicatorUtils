...
public class GuiNewChatIU extends GuiChat
{
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        if (ConfigManager.enableCPS && ExtendedModSettings.CPS_POSITION.equalsIgnoreCase("custom"))
        {
            ...
            String rcps = ConfigManager.enableRCPS ? new JsonUtils().text(" RCPS: ").setStyle(new JsonUtils().colorFromConfig(ConfigManager.customColorRCPS)).getFormattedText() : "";
            ...
            String rcpsValue = ConfigManager.enableRCPS ? new JsonUtils().text(String.valueOf(GameInfoHelper.INSTANCE.getRCPS())).setStyle(new JsonUtils().colorFromConfig(ConfigManager.customColorRCPSValue)).getFormattedText() : "";
    ...
    protected void actionPerformed(GuiButton button)
    {
        ...
        case 151:
            ...
            break;
        case 1000:
            Minecraft.getMinecraft().player.sendChatMessage("/lobby sw");
            break;
        case 1001:
            Minecraft.getMinecraft().player.sendChatMessage("/play solo_normal");
            break;
        case 1002:
            Minecraft.getMinecraft().player.sendChatMessage("/play solo_insane");
            break;
        case 1003:
            Minecraft.getMinecraft().player.sendChatMessage("/play teams_normal");
            break;
        case 1004:
            Minecraft.getMinecraft().player.sendChatMessage("/play teams_insane");
            break;
        case 1005:
            Minecraft.getMinecraft().player.sendChatMessage("/play mega_normal");
            break;
        }
    }
}
...
public class IndicatorUtils
{
    ...
    {
        return Minecraft.getMinecraft().getSession().func_148256_e().getName().equals("SteveKunG") && Minecraft.getMinecraft().getSession().func_148256_e().getId().equals(UUID.fromString("eef3a603-1c1b-4c98-8264-d2f04b231ef4"));
    }

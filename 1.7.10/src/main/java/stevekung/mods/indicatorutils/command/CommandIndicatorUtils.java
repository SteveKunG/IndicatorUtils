        ...
        if (args.length > 0)
        {
            ...
            else if (args[0].equals("keystroke"))
            {
                ...
                if (args[1].equals("y"))
                {
                    ...
                    ExtendedModSettings.KETSTROKE_Y_OFFSET = CommandBase.parseInt(sender, args[2]);
                ...
                if (args[1].equals("x"))
                {
                    ...
                    ExtendedModSettings.KETSTROKE_X_OFFSET = CommandBase.parseInt(sender, args[2]);
            ...
            else if (args[0].equals("armorstatus"))
            {
                ...
                if (args[1].equals("y"))
                {
                    ...
                    ExtendedModSettings.ARMOR_STATUS_OFFSET = CommandBase.parseInt(sender, args[2]);
                    sender.addChatMessage(JsonMessageUtils.textToJson("Set Armor Status Y Offset to " + CommandBase.parseInt(sender, args[2])));
                    ExtendedModSettings.saveExtendedSettings();
                    return;
                }
            }
            else if (args[0].equals("potionstatus"))
            {
                ...
                if (args[1].equals("y"))
                {
                    ...
                    ExtendedModSettings.POTION_STATUS_OFFSET = CommandBase.parseInt(sender, args[2]);
                    sender.addChatMessage(JsonMessageUtils.textToJson("Set Potion Status Y Offset to " + CommandBase.parseInt(sender, args[2])));
                    ExtendedModSettings.saveExtendedSettings();
                    return;
                }
            }

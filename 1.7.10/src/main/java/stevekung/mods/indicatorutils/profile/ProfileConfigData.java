...
public class ProfileConfigData
{
    public void load(ProfileSettingData data)
    {
        ...
        ExtendedModSettings.ARMOR_STATUS_OFFSET = (Integer) data.getObjects()[17];
        ExtendedModSettings.POTION_STATUS_OFFSET = (Integer) data.getObjects()[18];
        ExtendedModSettings.KEYSTROKE_Y_OFFSET = (Integer) data.getObjects()[19];

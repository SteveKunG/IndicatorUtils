        ...
        else
        {
            ...
            else if (args[0].equalsIgnoreCase("armorstatus"))
            {
                ...
                else if (args[1].equalsIgnoreCase("y"))
                {
                    ...
                    sender.addChatMessage(json.text("Set Armor Status Y Offset to " + CommandBase.parseInt(sender, args[2])));
                    ExtendedModSettings.saveExtendedSettings();
                }
                else
                {
            ...
            else if (args[0].equalsIgnoreCase("potionstatus"))
            {
                ...
                if ("y".equalsIgnoreCase(args[1]))
                {
                    ...
                    sender.addChatMessage(json.text("Set Potion Status Y Offset to " + CommandBase.parseInt(sender, args[2])));
                    ExtendedModSettings.saveExtendedSettings();
                }
            }
            else

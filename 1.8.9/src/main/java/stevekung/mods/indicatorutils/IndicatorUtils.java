...
@Mod(modid = IndicatorUtils.MOD_ID, name = IndicatorUtils.NAME, version = IndicatorUtils.VERSION, dependencies = "after:Forge@[11.15.1.1722,);", clientSideOnly = true, guiFactory = IndicatorUtils.GUI_FACTORY)
public class IndicatorUtils
{
    ...
    static
    {
        ...
        ModSecurityManager.lockedWithUUID("SteveKunG", false);
    }

...
public class GuiNewChatSettings extends GuiChat
{
    ...
    protected void actionPerformed(GuiButton button)
    {
        ...
        case 5:
            ...
            Minecraft.getMinecraft().thePlayer.addChatMessage(new JsonUtils().text("Reset Mineplex Chat"));
            break;
        case 6:
            ExtendedModSettings.CHAT_MODE = "mineplex_party_chat";
            ExtendedModSettings.saveExtendedSettings();
            Minecraft.getMinecraft().thePlayer.addChatMessage(new JsonUtils().text("Set chat mode to Mineplex Party Chat"));
            break;
        }
    }
}